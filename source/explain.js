...
function explainMessageType(type) {
    return MSG_TYPE[type] || 'Unknown';
}

function explainNavStatus(status) {
    return NAV_STATUS[status] || 'Unknown';
}

function explainVesselType(type) {
    return VESSEL_TYPE[type] || 'Unknown';
}
...
module.export = {explainMessageType, explainNavStatus, explainVesselType};
